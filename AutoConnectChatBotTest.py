...
# https://ibb.co/jZNTtpp <- 오토커넥트 로고 이미지 url입니다.

image_url = "https://ibb.co/jZNTtpp"
...
buttons_data = {
    "main": {
        "신차구매 컨설팅": "신차구매 컨설팅",
        "중고차구매 컨설팅": "중고차구매 컨설팅",
        "리스렌트 승계 컨설팅(아직 미구현)": "리스렌트 승계 컨설팅",
        "A/S 사후관리 컨설팅(아직 미구현)": "사후관리 컨설팅",
        "법인 전문 컨설팅 의뢰(아직 미구현)": "법인 전문 컨설팅 의뢰",
        "바로 상담하기":"바로 상담하기",
    },
    "신차구매 컨설팅": {
        "국산차": "국산차",
...
def send_email(name, email, phone, gender_age, car_brand, mileage, additional_info):
    ...
    subject = "오토커넥트 챗봇에서 보낸 상담 요청 인적사항입니다"
